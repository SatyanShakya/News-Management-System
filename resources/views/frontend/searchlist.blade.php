...
@section('content')
    ...
    <div class="container">
        <div class="bg0 flex-wr-sb-c p-rl-20 p-tb-8">
            ...
            <form action="{{ route('frontend.search', ['keyword' => request()->query('keyword')]) }}" method="GET">
    ...
    <div class="container p-t-4 p-b-40">
        <h2 class="f2-l-1 cl2">
            @if ($posts->count() > 0)
                {{ $posts->total() }} results found for keyword "<strong>{{ $keyword }}</strong>"
            @else
                                ...
                                @if ($posts->total() > $posts->perPage())
                                    <div class="flex-wr-s-c m-rl--7 p-t-15">
                                        ...
                                        @for ($i = 1; $i <= $posts->lastPage(); $i++)
                                            <a href="{{ $posts->url($i) . '&keyword=' . request()->query('keyword') }}"
